...
if __name__ == '__main__':
    urls = ['https://fe-api.zhaopin.com/c/i/sou?pageSize=90&cityId=702&salary=0,0&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=Python&kt=3&=0&_v=0.10086459&x-zp-page-request-id=6a89d831d31b4281b5923cb8d44f7707-1554795510384-844419',
            ...
            #'https://fe-api.zhaopin.com/c/i/sou?pageSize=90&cityId=702&workExperience=-1&education=-1&companyType=-1&employmentType=-1&jobWelfareTag=-1&kw=Java%E5%BC%80%E5%8F%91&kt=3&_v=0.64048684&x-zp-page-request-id=877d0c84e34444aa871e4e96978f6048-1554800734734-499092'
            ]
    t1 = threading.Thread(target=get_data(urls[1],name='Bigdata'),args=(1,))

    # t2 = threading.Thread(target=get_data(urls[1],name='java'),args=(2,))
    t1.start()
    # t2.start()
